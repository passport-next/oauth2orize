 ...
 * @api protected
 */
module.exports = function d(server, options, parse, complete) {
  ...
  options = options || {};
  parse = parse || function p(req, done) { return done(); };
  ...
  return function decision(req, res, next) {
    ...
    return parse(req, (err, ares, locals) => {
