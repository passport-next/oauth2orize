...
const clientCredentials = require('../../lib/exchange/clientCredentials');


describe('exchange.clientCredentials', () => {
  it('should be named client_credentials', () => {
    expect(clientCredentials(() => {}).name).to.equal('client_credentials');
  });
