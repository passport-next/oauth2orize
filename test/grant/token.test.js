...
const token = require('../../lib/grant/token');
...
describe('grant.token', () => {
  ...
  describe('decision handling', () => {
    ...
    describe('transaction that adds params to response', () => {
      let response;
    ...
    describe('transaction that adds params including token_type to response', () => {
      let response;
    ...
    describe('encountering an error while issuing token', () => {
      let err;
    ...
    describe('throwing an error while issuing token', () => {
      let err;
